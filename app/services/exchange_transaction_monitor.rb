...
class ExchangeTransactionMonitor
  ...
  def process_transaction(tx, block)
    begin
      ...
      event_abi = @contract.abi.find { |a| a["name"] == "exchangeDrexForTpft" }
      ...
      #   prazo: decoded_params[5],
      #   taxa_anual: decoded_params[6],
